    ...
    <Container maxW={"7xl"}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            Discover a centralized platform to manage users, albums, and photos
            seamlessly. Whether you're browsing, organizing, or editing,
            AlbumHub keeps things simple and efficient.
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
